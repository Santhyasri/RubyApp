...
class EmployeeDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_detail" do
    assert_difference('EmployeeDetail.count') do
      post employee_details_url, params: { employee_detail: { age: @employee_detail.age, designation: @employee_detail.designation, email: @employee_detail.email, gender: @employee_detail.gender, name: @employee_detail.name } }
    end
  ...
  test "should update employee_detail" do
    patch employee_detail_url(@employee_detail), params: { employee_detail: { age: @employee_detail.age, designation: @employee_detail.designation, email: @employee_detail.email, gender: @employee_detail.gender, name: @employee_detail.name } }
